...
print("Relative Distance table -> table_gaussian_mean: %s, %s"%tf_listener.lookupTransform("table_gaussian_mean", "table", rospy.Time(0)))
print("Relative_Distance drawer -> drawer_gaussian_mean %s, %s"%tf_listener.lookupTransform("drawer_gaussian_mean", "drawer", rospy.Time(0)))
print("Relative_Distance stove -> stove_gaussian_mean: %s, %s"%tf_listener.lookupTransform("stove_gaussian_mean", "stove", rospy.Time(0)))
print("Relative_Distance cupboard -> cupboard_gaussian_mean: %s, %s"%tf_listener.lookupTransform("cupboard_gaussian_mean", "cupboard", rospy.Time(0)))
