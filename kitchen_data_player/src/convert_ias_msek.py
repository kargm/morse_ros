...
# Write file including miliseconds
FILE = open(sys.argv[2],"w")
FILE.write("mSek,Hour,Min,Sek,mSek,x,y,z,u,v,w\n")
...
for row in posesReader:
    ...
    print("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n"%(msek, row["Hour"], row["Min"], row["Sek"], msek, row["x"], row["y"], row["z"], row["u"], row["v"], row["w"]))
