...
#export PYTHONPATH=/usr/lib/python3.2/dist-packages:$MORSE_DIR/morse/$PYTHON_INST_DIR:$ROSLIB_DIR/src
...
export MORSE_ROOT=$MORSE_DIR/morse
export MORSE_SRC_ROOT=$MORSE_DIR/morse-src  
echo $MORSE_ROOT
